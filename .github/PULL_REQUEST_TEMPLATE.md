...
- [ ] 新規 IPC コマンド / モジュール追加時は該当 spec の frontmatter (`ipc:` / `modules:`) + `reference/ipc-catalog.md` + `reference/file_inventory.md` を同期し、`node scripts/gen-architecture.mjs` で `reference/index.json` を再生成した
